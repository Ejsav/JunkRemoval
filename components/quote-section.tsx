  ...
  return (
    <section id="quote" data-section="quote" className="bg-background scroll-mt-20">
      <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
        <div className="px-6 sm:px-10 py-14 lg:px-16 lg:py-24 flex flex-col justify-center bg-foreground">
          ...
          <p className="text-background/75 leading-relaxed mb-9 max-w-md font-medium">
          ...
          <ul className="mt-9 flex flex-col gap-3 text-sm text-background/70 font-medium">
        ...
        <div className="bg-card px-6 sm:px-10 py-14 lg:px-16 lg:py-24 border-t lg:border-t-0 lg:border-l border-border">
